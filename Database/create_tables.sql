...
CREATE TABLE IF NOT EXISTS bronze.season_summary (
    ...
    viewers_premiere DOUBLE PRECISION,
    viewers_finale DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS bronze.castaway_scores (
    ...
    score_challenge DOUBLE PRECISION,
    score_vote DOUBLE PRECISION,
    score_adv DOUBLE PRECISION,
    score_inf DOUBLE PRECISION,
    score_survivability DOUBLE PRECISION,
    score_read DOUBLE PRECISION,
    threat_challenge DOUBLE PRECISION,
    threat_challenge_cat TEXT,
    threat_strategic DOUBLE PRECISION,
    threat_strategic_cat TEXT,
    threat_level DOUBLE PRECISION,
    threat_level_cat TEXT,
    threat_level_rank INT,
    p_threat_challenge DOUBLE PRECISION,
    p_threat_strategic DOUBLE PRECISION,
    p_threat_level DOUBLE PRECISION,
    r_score_result DOUBLE PRECISION,
    r_score_jury DOUBLE PRECISION,
    ...
    r_score_challenge DOUBLE PRECISION,
    r_score_vote DOUBLE PRECISION,
    r_score_adv DOUBLE PRECISION,
    r_score_inf DOUBLE PRECISION,
    r_score_survivability DOUBLE PRECISION,
    r_score_read DOUBLE PRECISION,
    r_score_db_votes DOUBLE PRECISION,
    p_score_result DOUBLE PRECISION,
    p_score_jury DOUBLE PRECISION,
    ...
    p_score_inf DOUBLE PRECISION,
    p_score_survivability DOUBLE PRECISION,
    p_score_read DOUBLE PRECISION,
    p_score_challenge DOUBLE PRECISION,
    source_dataset TEXT,
    ingested_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
